...
type Props = KeepMotorsRunningDialogDialogPublicProps & KeepMotorsRunningDialogDialogPrivateProps;
...
class KeepMotorsRunningDialogDialog extends React.PureComponent<Props> {
    ...
    return (
      <Dialog theme={theme} name={LocalizedString.lookup(tr('Close Motor, Servo, Sensor Tab?'), locale)} onClose={onClose}>
        <Container theme={theme}>
          <br />
          <CenteredContainer>
            <Bold>{LocalizedString.lookup(tr(`There are moving motors and/or servos and you want to close this tab.`), locale)}</Bold>
            <Bold>{LocalizedString.lookup(tr(`Do you want them to stay on?`), locale)}</Bold>
          </CenteredContainer>
          <br />
          <CenteredContainer>

            <BottomButtonContainer>
              <YesItem onClick={() => this.props.onKeepRunning("yes")} theme={theme}>
                Yes
              </YesItem>
...
}))(KeepMotorsRunningDialogDialog) as React.ComponentType<KeepMotorsRunningDialogDialogPublicProps>;